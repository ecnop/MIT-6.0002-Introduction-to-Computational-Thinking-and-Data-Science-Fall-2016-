...
class Digraph(object):
    ...
    def __init__(self):
        self.nodes = set([])
        self.edges = {}  # must be a dict of Node -> list of edges. I'm assuming only the edges that start in the node...
    ...
    def add_node(self, node):
        ...
        #If the node is already in the list of nodes, raise a Value Error, if not
        # add the node to the nodes set and create a key in the edges dictionary
        # with that node
    ...
    def add_edge(self, edge):
        ...
        in the  graph."""
        # Grab the source and destination of the edge with the getter methods,
        # and if both of these exist within the nodes list of the graph, append
        # the edge into the list corresponding to the key of the source node,
        # if anyone of the nodes dont exist, raise a Value Error.
        src = edge.get_source()
